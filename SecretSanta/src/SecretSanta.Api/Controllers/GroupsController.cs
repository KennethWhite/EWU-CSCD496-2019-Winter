...
namespace SecretSanta.Api.Controllers
{
    ...
    public class GroupsController : ControllerBase
    {
        ...
        {
            var groups = (await GroupService.FetchAll()).Select(x => Mapper.Map<GroupViewModel>(x));
            return Ok(groups);
        }
        ...
        public async Task<IActionResult> Post(GroupInputViewModel viewModel)
        {
            ...
            return CreatedAtAction(nameof(Post), new { id = createdGroup.Id}, Mapper.Map<GroupViewModel>(createdGroup));
        }
